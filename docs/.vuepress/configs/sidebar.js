  ...
  '/game-biz/': [
    {
      ...
      children: [
        ...
        '/game-biz/anti-cheat.md',
        '/game-biz/economy-progression.md',
  ...
  '/ai-llm/': [
    {
      ...
      children: [
        ...
        '/ai-llm/agent-dev.md',
        '/ai-llm/llm-security.md',
        '/ai-llm/llm-evaluation.md',
        '/ai-llm/llm-cost-latency.md',
        '/ai-llm/fine-tuning.md',
        '/ai-llm/ai-eng-practices.md',
      ],
    },
  ],
  ...
  '/algo/': [
    ...
    },
    {
      ...
      children: [
        ...
        '/algo/union-find.md',
        '/algo/intervals.md',
        '/algo/string-matching.md',
        '/algo/bit-manipulation.md',
        '/algo/math-number-theory.md',
      ],
    },
    {
      text: '后台高频算法',
  ...
  '/common/': [
    {
      ...
      children: [
        ...
        '/common/time-series-anomaly-detection.md',

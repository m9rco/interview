...
title: 首页
heroText: 9 年后台经验归档
tagline: 互联网/智能硬件后台 3 年 + 游戏局外后台 6 年 · 场景 → 实现 → 为什么这么做 → 为什么别的不行 → 沉淀
actions:
  - text: 个人经历 & 心法
    link: /intro/
    type: primary
...
footer: 归档 & 复习用 · 由 VuePress 生成 · 发布于 GitHub Pages / interview.0x06.cn
---

## 这份归档是什么

过去 9 年的后台工作分两段：**3 年互联网 / 智能硬件后台** + **6 年游戏局外后台**。这份站点把这些经验按"域"归档，每个专题统一用五段式组织：

...
这一域覆盖游戏局外后台的基础架构、网络、有状态服务、算法与工具，共 17 个专题：

**接入与通信**
- [tconnd 接入层](/game-infra/tconnd.md) · [TBus 通信总线](/game-infra/tbus.md)
...
**有状态服务**
- [数据迁移](/game-infra/stateful-migration.md) · [数据恢复](/game-infra/stateful-recovery.md) · [配置热刷新](/game-infra/config-hot-reload.md)

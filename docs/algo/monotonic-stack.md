...
**打个比方**：把元素想成排队等着"被后面的人看见"的一群人，按身高从栈底到栈顶递减站好。来了个高个子新人，前面所有比他矮的人瞬间全被"挡没了"——对更后面的任何人来说，这些矮子永远躲在高个子背后、再无出头之日，直接出局。而某个矮子被挤出队的那一刻，正好锁定了"他右边第一个比他高的人"就是这位新来的高个子。**类比失效边界**：现实里被淘汰还能打复活赛，单调栈里**被弹出即永久出局、不再参与任何后续比较**——正是这个"进出各一次"的铁律，保证了总复杂度是 O(n) 而非 O(n²)。

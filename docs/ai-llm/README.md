...
这一域覆盖大语言模型的**核心原理**与**工程优化**，以及基于 LLM 的应用开发（RAG、Agent）与**研发工程化落地**，共 6 个专题：
...
- [AI 研发工程化](/ai-llm/ai-eng-practices.md) —— OpenSpec/Superpowers/CodeGraph/evomap 原理、Skill vs 经验演化、存量代码知识库与可复用组件的企业级选型
